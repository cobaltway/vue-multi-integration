...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _vueMultilanguage = __webpack_require__(3);

	var _vueMultilanguage2 = _interopRequireDefault(_vueMultilanguage);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	_vue2.default.use(_vueMultilanguage2.default, {
	    default: 'en',
	    en: {
	        hi: 'Hello',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var MultiLanguage = function () {
	  function MultiLanguage() {
	    (0, _classCallCheck3.default)(this, MultiLanguage);
	  }

	  (0, _createClass3.default)(MultiLanguage, [{
	    key: 'init',
	    ...
	    value: function init(_languages, _vue) {
	      ...
	      if (!userLang) {
	        userLang = (0, _keys2.default)(this.languages)[0];
	      }
	    ...
	    value: function relaunchByDirective(el, binding, vnode) {
	      ...
	      if (hasParams) {
	        ...
	        if ((typeof params === 'undefined' ? 'undefined' : (0, _typeof3.default)(params)) !== 'object') params = [params];
	      }
	      ...
	      function getLanguage(current) {
	        ...
	        (0, _keys2.default)(binding.modifiers).forEach(function (path) {
	      ...
	      if (current && hasParams) {
	        (0, _keys2.default)(params).forEach(function (path) {
	    ...
	    value: function matchLanguage(lang) {
	      if (!lang) return '';
	      var match = '';
	      (0, _keys2.default)(this.languages).forEach(function (path) {
